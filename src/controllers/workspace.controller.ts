...
export const createWorkspaceController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { workspace } = await createWorkSpace(userId, body);
...
export const getAllWorkspacesUserIsMemberController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { workspaces } = await getAllWorkspacesUserIsMember(userId);
    return res
...
export const updateWorkspaceByIdController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { workspace } = await updateWorkspaceById(
      workspaceId,
      name,
      description
    );
...
export const deleteWorkspaceByIdController = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { currentWorkspace } = await deleteWorkspace(workspaceId, userId);
    return res
      .status(HTTPSTATUS.OK)
